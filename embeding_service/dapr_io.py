"""Publish events to the Dapr sidecar over HTTP.

Keeping this to a plain httpx call against the sidecar avoids pulling the full
Dapr gRPC SDK. The sidecar address comes from DAPR_HTTP_PORT (injected by Dapr).
"""
