...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      <main
        className="flex-1 pt-20 px-[var(--sp-lg)] pb-8 flex flex-col md:flex-row gap-[var(--sp-lg)] max-w-[1440px] mx-auto w-full"
      >
        {view === "dashboard" && (
          <>
...
function LiveAIPanel({ isLive }: { isLive: boolean }) {
  ...
  return (
    ...
    >
      ...
      <div className="p-[var(--sp-md)] flex flex-col gap-[var(--sp-sm)]">
        ...
        {!isLive && !hasData && (
          <div className="flex flex-col gap-[var(--sp-sm)]">
            <div className="flex items-start gap-[var(--sp-sm)]">
              ...
              >
                Send a message or upload a file to activate analysis.
              </div>
            </div>
        ...
        {/* State 3: Active — categorized insights + chat events */}
        {hasData && (
          <div className="overflow-y-auto no-scrollbar flex flex-col gap-[var(--sp-sm)]" style={{ maxHeight: 280 }}>
            ...
            {/* Chat-derived coaching / audience events */}
