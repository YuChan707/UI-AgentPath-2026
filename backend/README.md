...
| `services/` | Integrations: `chroma_service`, `email_service`, `ingestion_service`, `document_service`, `pptx_generator`, `llm_factory` |
...
- Per-environment config (DB, Chroma, LLM): see
